...
void UW::UI_AssetLoader::finalizeImport() {
  Logger::get().info("UI_AssetLoader", "Finalizing Import...");
  ...
  Logger::get().info("UI_AssetLoader", "Import successful!");
  clearTemporaryData(); 
};



void UW::UI_AssetLoader::finalizeMaterials(){
...
void UW::UI_AssetLoader::finalizeMesh(aiMesh* aMesh, const std::string& final_mesh_name){

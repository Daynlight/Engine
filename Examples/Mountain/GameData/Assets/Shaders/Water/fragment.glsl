...
void main(){
  ...
  vec3 color = material[mat_translate[0]].albedo * 0.1f;
  ...
  for(int i = 0; i < lightCount; i++){
    ...
    color += BRDF(
      ...
      lights[i].position,
      lights[i].color,
      material[mat_translate[0]].albedo,
      material[mat_translate[0]].metallic,
      material[mat_translate[0]].roughness,
      material[mat_translate[0]].emission_color,
      material[mat_translate[0]].emission_strength,
      material[mat_translate[0]].ambient_occlusion
    ) * lights[i].strength;
  };

  float alpha = clamp(0.2 + fresnel, 0.0, 0.6);
